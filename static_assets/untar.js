...
function TarLocalFile(bstream) {
    ...
    this.mode = parseInt(readCleanString(bstream, 8));
    this.uid = parseInt(readCleanString(bstream, 8));
    this.gid = parseInt(readCleanString(bstream, 8));
    
    this.size = parseInt(readCleanString(bstream, 12), 8);
    this.mtime = parseInt(readCleanString(bstream, 12));
